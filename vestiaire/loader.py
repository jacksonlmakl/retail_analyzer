"""Snowflake loader for the VESTIAIRE schema."""
...
SCHEMA = "VESTIAIRE"
SETUP_SQL_PATH = get_setup_path("vestiaire")
    ...
    try:
        ...
        cur.execute(f"""
            INSERT INTO PRODUCTS (
                ...
                DESIGNER, CONDITION, SIZE_INFO, MATERIAL, CATEGORY, COLOR
            )
            SELECT
                {run_id},
                $1:title::VARCHAR,
        ...
        print(f"[+] Loaded {loaded} Vestiaire products (run #{run_id})")
