"""FastAPI server for Vestiaire Collective scraping."""

from celery.result import AsyncResult
from fastapi import FastAPI
from pydantic import BaseModel

from vestiaire.tasks import app as celery_app, scrape_and_load

app = FastAPI(title="Vestiaire Collective Scraper API", version="1.0.0")
