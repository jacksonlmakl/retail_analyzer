"""Snowflake loader for the FASHIONPHILE schema."""
...
SCHEMA = "FASHIONPHILE"
SETUP_SQL_PATH = get_setup_path("fashionphile")
    ...
    try:
        ...
        cur.execute(f"""
            INSERT INTO PRODUCTS (
                ...
                DESIGNER, CONDITION, CATEGORY, COLOR, MATERIAL
            )
            SELECT
                {run_id},
                $1:title::VARCHAR,
        ...
        print(f"[+] Loaded {loaded} Fashionphile products (run #{run_id})")
