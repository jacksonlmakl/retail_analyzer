"""FastAPI server for Fashionphile scraping."""

from celery.result import AsyncResult
from fastapi import FastAPI
from pydantic import BaseModel

from fashionphile.tasks import app as celery_app, scrape_and_load

app = FastAPI(title="Fashionphile Scraper API", version="1.0.0")
