"""FastAPI server for triggering Google Shopping scrape tasks."""

from celery.result import AsyncResult
from fastapi import FastAPI
from pydantic import BaseModel

from google_shopping.tasks import app as celery_app, scrape_and_load

app = FastAPI(title="Google Shopping Scraper API", version="1.0.0")
