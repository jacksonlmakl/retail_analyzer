"""Celery tasks for Grailed scraping."""
...
app = Celery("grailed")
app.config_from_object("grailed.celeryconfig")


@app.task(bind=True, name="grailed.tasks.scrape_and_load")
def scrape_and_load(self, query, pages=1, country="us", language="en"):
    from grailed.scraper import search, save_product_images, save_to_json
    from grailed.loader import get_connection, upload_and_load
