"""Snowflake loader for the FARFETCH schema."""
...
SCHEMA = "FARFETCH"
SETUP_SQL_PATH = get_setup_path("farfetch")
    ...
    try:
        ...
        cur.execute(f"""
            INSERT INTO PRODUCTS (
                ...
                DESIGNER, PRE_OWNED, CATEGORY, COLOR
            )
            SELECT
                {run_id},
                $1:title::VARCHAR,
                ...
                COALESCE($1:pre_owned::BOOLEAN, FALSE),
        ...
        print(f"[+] Loaded {loaded} Farfetch products (run #{run_id})")
